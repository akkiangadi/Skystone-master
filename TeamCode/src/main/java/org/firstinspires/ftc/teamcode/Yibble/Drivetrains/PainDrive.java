package org.firstinspires.ftc.teamcode.Yibble.Drivetrains;
...
public class PainDrive {
    ...
    public void PainDriveAssign(DcMotor fle, DcMotor fre, DcMotor ble, DcMotor bre){
        this.fl = fle;
        this.fr = fre;
        this.bl = ble;
        this.br = bre;
    ...
    public void drivetrainInputs(double rightStickXe, double leftTriggere, double rightTriggere){
